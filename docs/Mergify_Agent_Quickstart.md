...
- Scripts: `/Users/m/ai/scripts/dev/` (`push_with_codex.sh`, `request_codex_review.sh`)
- Branch state: `/Users/m/ai/branch_state_<repo>.json` (one per repo)
...
## What To Do
1) Work in `/Users/m/ai` (use worktrees if `main` is dirty).
