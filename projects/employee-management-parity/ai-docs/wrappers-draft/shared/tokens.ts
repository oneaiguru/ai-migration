...
export const fontWeightVar = (
  weight: 'fontWeightRegular' | 'fontWeightMedium' | 'fontWeightSemibold' | 'fontWeightBold',
) => tokenVar('typography', weight);

export const fontSizeVar = (
  size: 'sizeXs' | 'sizeSm' | 'sizeMd' | 'sizeLg' | 'sizeXl' | 'sizeDisplay',
) => tokenVar('typography', size);

export const lineHeightVar = (
  size: 'lineHeightTight' | 'lineHeightDefault' | 'lineHeightRelaxed',
) => tokenVar('typography', size);
