...
- **Internal documentation** (chapter extracts used by browser agent):
  - `${MANUALS_ROOT}/CH3_Employees.pdf`
  - `${MANUALS_ROOT}/CH5_Schedule_Advanced.pdf`
  - `${MANUALS_ROOT}/CH5_Schedule_Build.pdf`
  - `${MANUALS_ROOT}/CH6_Reports.pdf`
  - `${MANUALS_ROOT}/orchestrator/argus/imports/code/CH7_Appendices.md`
...
- `${CE_MAGIC_PROMPTS_DIR}/RESEARCH-FOLLOWING-MAGIC-PROMPT.md`
