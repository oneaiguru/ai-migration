...
Start Here
- `docs/START_HERE.md` – entry point and decision tree for all roles
- `docs/STATUS_DASHBOARD.md` – current active work summary (PROGRESS.md remains canonical)
...
- `System/` – architecture snapshots & parity guardrails.
  ...
  - `docs-coordinator-overview.md` – docs roles and coordination
...
- `docs/SOP/uat/master-uat-workflow.md` (UAT index)
  - `ui-walkthrough-checklist.md`
  - `uat-delta-walkthrough-sop.md`
  - `ai-uat-browser-agent.md`
  - `fast-path-exceptions.md`
  - `prd-feedback-sop.md`
  - `session-prep-and-handoff.md`
  - `artifacts/` – handoff template, decision tree diagram, troubleshooting, validation checklist
