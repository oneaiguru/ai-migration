...
- External manuals (CH3–CH7) remain in `${MANUALS_ROOT}/…` for future validation. See `docs/System/path-conventions.md`.
...
1. Review `docs/Archive/Tasks/05_phase-5-stabilization-and-validation-prd.md` alongside `~/Desktop/ff.markdown` for the stabilization scope.
