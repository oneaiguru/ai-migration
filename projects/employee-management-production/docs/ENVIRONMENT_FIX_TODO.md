...
4. Re-run tooling checks in the parity repo:
   ...
   # After migrating code from ai-docs/ or enabling new wrappers, audit dependencies
   # (e.g. install @radix-ui/react-dialog) so Vite/Rollup doesn’t fail at build time.
   ```
