...
- **Shared overlays/utils** – `src/components/common/Overlay.tsx` + `@wrappers/ui/Dialog.tsx` manage focus and accessibility for modals/drawers; `src/utils/task.ts` handles timeline entries.
