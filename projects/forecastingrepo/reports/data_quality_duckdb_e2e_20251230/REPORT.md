...
|----------|-------|--------|
| 🔴 BLOCKER | 0 | None |
| 🟡 WARNING | 2 | baseline_extreme=1003 (4.6%), outliers_3sigma=107569 (2.1%) |
...
**Sites Missing Registry:** 0 → See `coverage_missing_registry.csv`
...
**Baseline Deviations:** 1003 sites (4.6% of baseline sites) → See `distribution_baseline.csv`
...
|------|------|-------------|
| coverage_missing_registry.csv | 0 | Sites missing from registry |
