...
- Cron wrapper: `/Users/m/aa/scripts/dev/run_coordinator.sh` (PATH + GH_TOKEN sourcing)
- Codex triggers: `/Users/m/aa/scripts/dev/push_with_codex.sh`, `/Users/m/aa/scripts/dev/request_codex_review.sh`
- Branch state (optional gating): `/Users/m/aa/branch_state_<repo>.json`

## Required Env
- Set `GH_TOKEN` (or `GITHUB_TOKEN`) in an untracked file (`~/.ai-coordinator-env` or `/Users/m/aa/.env`).
- Cron entry (example): `*/5 * * * * cd /Users/m/aa && ALLOWED_REPOS=oneaiguru/aa REQUIRED_CHECKS= COORDINATOR_APPROVE=false ./scripts/dev/run_coordinator.sh >> /Users/m/aa/coordinator.log 2>&1`
