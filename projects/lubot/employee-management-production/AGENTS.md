...
| --- | --- | --- | --- |
| Scout | `/Users/m/Documents/replica/orchestrator/argus/imports/code/CE_MAGIC_PROMPTS/SIMPLE-INSTRUCTIONS.md`<br>`/Users/m/Documents/replica/orchestrator/argus/imports/code/CE_MAGIC_PROMPTS/RESEARCH-FOLLOWING-MAGIC-PROMPT.md` | `docs/SOP/code-change-plan-sop.md` (Exploration) | Discovery notes + `docs/SESSION_HANDOFF.md` entry |
| Planner | `/Users/m/Documents/replica/orchestrator/argus/imports/code/CE_MAGIC_PROMPTS/SIMPLE-INSTRUCTIONS.md`<br>`/Users/m/Documents/replica/orchestrator/argus/imports/code/CE_MAGIC_PROMPTS/PLAN-USING-MAGIC-PROMPT.md` | `docs/SOP/code-change-plan-sop.md` (Plan authoring) | `plans/YYYY-MM-DD_<task>.plan.md` + handoff update |
| Executor | `/Users/m/Documents/replica/orchestrator/argus/imports/code/CE_MAGIC_PROMPTS/SIMPLE-INSTRUCTIONS.md`<br>`/Users/m/Documents/replica/orchestrator/argus/imports/code/CE_MAGIC_PROMPTS/EXECUTE-WITH-MAGIC-PROMPT.md` | `docs/SOP/plan-execution-sop.md` | Code changes, tests, documentation updates |

See `docs/System/context-engineering.md` for the full context engineering playbook.
