...
flowchart TD
  ...
  Handoff -- yes --> NextAgent([Hand off to next agent])
...
2. Consult `docs/System/context-engineering.md` and read the CE_MAGIC prompt set for your role:
   - **Scout:** `SIMPLE-INSTRUCTIONS.md` + `RESEARCH-FOLLOWING-MAGIC-PROMPT.md`
   - **Planner:** `SIMPLE-INSTRUCTIONS.md` + `PLAN-USING-MAGIC-PROMPT.md`
   - **Executor:** `SIMPLE-INSTRUCTIONS.md` + `EXECUTE-WITH-MAGIC-PROMPT.md`
