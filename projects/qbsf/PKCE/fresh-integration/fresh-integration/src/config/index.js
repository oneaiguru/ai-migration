...
module.exports = {
  ...
  salesforce: {
    ...
    redirectUri: process.env.SF_REDIRECT_URI || 'http://localhost:3000/auth/salesforce/callback',
    loginUrl: process.env.SF_LOGIN_URL || 'https://login.salesforce.com'
  },
  quickbooks: {
    clientId: process.env.QB_CLIENT_ID,
    clientSecret: process.env.QB_CLIENT_SECRET,
    redirectUri: process.env.QB_REDIRECT_URI || 'http://localhost:3000/auth/quickbooks/callback',
    environment: process.env.QB_ENVIRONMENT || 'sandbox'
  },
  security: {
    apiKey: process.env.API_KEY || 'quickbooks_salesforce_api_key_2025',
