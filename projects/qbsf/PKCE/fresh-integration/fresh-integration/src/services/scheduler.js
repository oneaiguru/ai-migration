...
class Scheduler {
  ...
  async runInvoiceCreationNow() {
    try {
      ...
      // Use our integration workflow script
  ...
  async runPaymentCheckNow() {
    try {
      ...
      // Since we don't have a full payment check implementation yet, we'll return a mock result
      // In a real implementation, you would call your payment check service
      
      logger.info('Manual payment check completed - mock implementation');
      ...
      return {
        ...
        paidInvoicesFound: 0,
        invoicesUpdated: 0,
        message: "This is a mock implementation. No actual payment check performed."
      };
    } catch (error) {
