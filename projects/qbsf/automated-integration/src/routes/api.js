...
router.post('/create-invoice', async (req, res, next) => {
  try {
    ...
    logger.info(`Fetching Opportunity: ${opportunityId} (SIMULATED)`);
    logger.info(`Opportunity Name: Demo Opportunity, Amount: 1500.00 (SIMULATED)`);
    logger.info(`Account Name: Demo Account (SIMULATED)`);
