...
OPPORTUNITY_ID="006QBjWnuEzXs5kUhL" # Test opportunity ID - Replace if needed
SF_INSTANCE="https://customer-inspiration-2543.my.salesforce.com"
QB_REALM="9341454378379755" # Actual QuickBooks realm ID
...
echo "2. Payment information updated (if invoice was marked as paid)"
