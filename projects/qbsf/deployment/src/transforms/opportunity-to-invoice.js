...
function mapOpportunityToInvoice(opportunity, account, products, qbCustomerId) {
  ...
  try {
    ...
    const lineItems = products.map(product => ({
      ...
      SalesItemLineDetail: {
        ItemRef: {
          value: product.Product2 && product.Product2.QB_Item_ID__c ? product.Product2.QB_Item_ID__c : "1", // Fallback to a default item
          name: product.Product2 ? product.Product2.Name : "Product"
        },
