 ...
 * Handles recurring synchronization between Salesforce and QuickBooks
 */
...
class Scheduler {
  ...
  /**
   * Start the scheduler - initiates automated background processes
   */
  start() {
  ...
  stop() {
    ...
    logger.info('Scheduler stopped - all automated tasks paused');
  }
  
  /**
   * Setup the invoice creation job
   * This job automatically finds Salesforce opportunities and creates QuickBooks invoices
   */
   ...
   * This job automatically checks QuickBooks for payments and updates Salesforce
   */
  ...
  /**
   * Log job run results to file for audit purposes
   */
  ...
  /**
   * Log job errors to file for troubleshooting
   */
  ...
  /**
   * Run the invoice creation job immediately - for testing or one-time runs
   */
  ...
  /**
   * Run the payment check job immediately - for testing or one-time runs
   */
