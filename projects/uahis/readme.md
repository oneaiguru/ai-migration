# Things MCP Server (+ TUI Clone Project)

> **Note**: This project now contains both:
> 1. **Original MCP Server** - Integrate Things with Claude Desktop
> 2. **New TUI Clone** - Terminal UI for Things tasks (Phase 1 implementation)
> 
> See [README_THINGS_TUI.md](./README_THINGS_TUI.md) for the TUI project status.
