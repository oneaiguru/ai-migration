...
This template is not ready until you edit the files below. Start with `docs/SOP/loop_start.md` for the single-brief startup flow.

Checklist
0. docs/SOP/loop_start.md
- Follow the one-brief startup steps before running the loop.
