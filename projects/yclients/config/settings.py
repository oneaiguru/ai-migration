...
def _env(*keys: str, default: str = "") -> str:
    """Return the first non-empty env value for given keys."""
    for key in keys:
...
# Настройки Supabase
SUPABASE_URL = _env("SUPABASE_URL", "TIMEWEB_SUPABASE_URL", default="")
SUPABASE_KEY = _env("SUPABASE_KEY", "SUPABASE_SERVICE_ROLE_KEY", "SUPABASE_SERVICE_ROLE", "TIMEWEB_SUPABASE_KEY", default="")
...
try:
    ...
    SUPABASE_URL = _env("SUPABASE_URL", "TIMEWEB_SUPABASE_URL", default=SUPABASE_URL)
    SUPABASE_KEY = _env("SUPABASE_KEY", "SUPABASE_SERVICE_ROLE_KEY", "SUPABASE_SERVICE_ROLE", "TIMEWEB_SUPABASE_KEY", default=SUPABASE_KEY)
